...
<div class="small-container">
    ...
    <div class="row">
        @foreach($feature_product as $fprod)
        <div class="col-4">
        <a href="{{ url('/products/'.$fprod->id) }}">
        <img src="{{ asset(explode('|', $fprod->image)[0]) }}" height="200" width="250">
        </a>
            <h4>{{$fprod->name}}</h4>
            <div class="rating">
...
<h2 class="title">Latest Products</h2>
    <div class="row">
        @foreach($latest_product as $product)
            <div class="col-4">
                <a href="{{ url('/products/'.$product->id) }}"><img src="{{ asset(explode('|', $product->image)[0]) }}" height="200" width="250"></a>
