...
<body>
    ...
    <div class="small-container single-product">
        <div class="row">
            ...
            <div class="col-2">
                ...
                <p>{{$product->category->categories_name}}</p>
                <h1>{{$product->name}}</h1>
            ...
            <form method="POST" action="/add-to-cart">
                ...
                <label>Amount</label>
                <input name="quantity" id="qty" type="text" value="1" onchange="validateAmount(this.value,{{$product->id}} )">
    ...
    <div class="small-container">
        <div class="row row-2">
            ...
            <p><a href="{{ url('/products/') }}">View More
            </a></p>
        </div>
    </div>
    ...
    <div class="small-container">
        ...
        @foreach($related_product as $rel_product)
            <div class="col-4">
            <a href="{{ url('/products/'. $rel_product->id) }}">
            <img src="{{ asset(explode('|', $rel_product->image)[0])}}" height='200px' width='250px'>
            </a>
